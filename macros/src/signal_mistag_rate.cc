...
{
  const char* inDir = "/nfs/dust/cms/user/albrecha/uhh2_102X_v2/HOTVRStudiesOutput/root/paper_jet_collections/HOTVR_SD_adaptive_R/HISTS/";
...
//  leg->AddEntry(bkg_eff[0], "#alpha = 1, #rho = 600 GeV", "lep");
  ...
  canvas->SaveAs(outdir + "signal_eff.pdf");
